...
const Home = () => {
  return (
    <>
      <div className="homeSec container-fluid">
        <h1 id="line1">
          The <span id="beautiful"> </span> Idea,
        </h1>
        <h2 id="line2">To Save Ideas.</h2>
        <h3 id="line3">Build, Save and Explore later</h3>
        <div id="svg-container">
          <svg id="svg" data-name="Layer 1" viewBox="0 0 931.56299 512.801">
            <circle cx="347.12667" cy="325.96388" r="26.43632" fill="#6c63ff" />
            <polygon
            ...
            <path
              ...
              fill="#fff"
            />
            <circle cx="510.22347" cy="42" r="21.33847" fill="#6c63ff" />
            <path
            ...
            <path
              ...
              fill="#2f2e41"
            />
            <circle cx="905.12667" cy="41.96388" r="26.43632" fill="#6c63ff" />
            <polygon
        ...
        <p id="line4">
          The <strong>PEN</strong> application is just a simple ideology for
          people
          <br /> to keep their short notes in hands.
        </p>
        <Link to="/dashboard">
